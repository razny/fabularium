<header class="navbar navbar-expand-sm navbar-light bg-light sticky-top">
    <div class="container-fluid d-flex justify-content-around w-75">
        ...
        <ul class="navbar-nav d-flex align-items-center ms-2">
            <li class="nav-item">
                <a class="nav-link" href="koszyk.php"><img src="images/shopping-cart-icon.svg" width="32" height="32" alt="Logo" /></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="logowanie.php"><img src="images/user-icon.svg" width="28" height="28" alt="Logo" /></a>
            </li>
        </ul>
    </div>
</header>
